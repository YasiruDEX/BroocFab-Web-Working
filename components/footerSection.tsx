      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-12 mb-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed max-w-sm">
              Sri Lanka&apos;s premium digital fabrication studio. Delivering
              precise, high-performance 3D printing and rapid physical
              prototyping with engineering-grade polymers.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-slate-900/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono">
          ...
          <div className="flex gap-4 items-center">
            <a
              href="mailto:hello@broocfab.com"
              className="hover:text-blue-400 flex items-center gap-1.5 text-slate-400 font-bold transition-colors"
            >
