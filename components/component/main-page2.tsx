      ...
      <div className="flex flex-col items-center justify-center bg-gradient-to-r from-[#0a0e24] to-[#2c3678] p-8 md:p-20">
        <div className="w-full max-w-2xl space-y-4">
          ...
          <p className="text-gray-400 text-center">
            We make sure to provide you the best 3D printing service ensuring
            the print quality. We will manually inspect your 3D model to provide
            you the best price by calculating the material cost and print time.
          </p>
          ...
          <div className="flex gap-8 overflow-x-auto py-8 snap-x snap-mandatory">
            <Card className="flex-shrink-0 snap-center w-full max-w-md py-5 bg-gradient-to-r from-[#000000] to-[#181d33] hover:from-[#000030] hover:to-[#181d33]">
              <CardContent>
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                  ...
                  listened to my needs and delivered exactly what I envisioned.
                  I couldn&apos;t be happier with the outcome and will
            ...
            <Card className="flex-shrink-0 snap-center w-full max-w-md py-5 bg-gradient-to-r from-[#000000] to-[#181d33] hover:from-[#000030] hover:to-[#181d33]">
              <CardContent>
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                  &quot;The precision and quality of BroocFab&apos;s 3D prints
                  are incredible. Every project I have done with them has
                  exceeded my expectations. Highly recommend for any
                  professional looking for reliable 3D printing services.&quot;
                </p>
              </CardContent>
            </Card>
            <Card className="flex-shrink-0 snap-center w-full max-w-md py-5 bg-gradient-to-r from-[#000000] to-[#181d33] hover:from-[#000030] hover:to-[#181d33]">
            ...
            <Card className="flex-shrink-0 snap-center w-full max-w-md py-5 bg-gradient-to-r from-[#000000] to-[#181d33] hover:from-[#000030] hover:to-[#181d33]">
              <CardContent>
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                  ...
                  prints from BroocFab. They have a keen eye for detail and
                  ensure that every aspect of the print is perfect. I
                  wouldn&apos;t go anywhere else for my 3D printing needs.&quot;
                </p>
              </CardContent>
            </Card>
            <Card className="flex-shrink-0 snap-center w-full max-w-md py-5 bg-gradient-to-r from-[#000000] to-[#181d33] hover:from-[#000030] hover:to-[#181d33]">
              <CardContent>
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                  &quot;Working with BroocFab has been an absolute pleasure.
        ...
        <div className="container max-w-4xl px-4 md:px-6">
          ...
          <div className="mt-12 space-y-4">
            ...
            <Collapsible className="rounded-md border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-950">
              ...
              <CollapsibleContent className="border-t border-gray-200 px-4 py-3 dark:border-gray-800">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  We are trying our best to deliver it at the earliest, worst
                  case would be in 24 hours maximum. If not, please contact us
                  via 0702534485.
                </p>
              </CollapsibleContent>
            </Collapsible>
            <Collapsible className="rounded-md border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-950">
              ...
              <CollapsibleContent className="border-t border-gray-200 px-4 py-3 dark:border-gray-800">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  eZcash and mCash, Frimi, iPay, Sampath Bank (Vishwa) or HNB
            ...
            <Collapsible className="rounded-md border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-950">
              ...
              <CollapsibleContent className="border-t border-gray-200 px-4 py-3 dark:border-gray-800">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  We deliver 3D printed objects to any part of Sri Lanka. It
                  will take 1-2 days to receive the objects after print
                  completion.
                </p>
              </CollapsibleContent>
            </Collapsible>
            <Collapsible className="rounded-md border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-950">
              ...
              <CollapsibleContent className="border-t border-gray-200 px-4 py-3 dark:border-gray-800">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Yes, of course, we will never share your files with a 3rd
                  party.
                </p>
              </CollapsibleContent>
            </Collapsible>
