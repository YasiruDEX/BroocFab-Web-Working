          ...
          <div className="space-y-8 lg:col-span-7 flex flex-col justify-center text-left">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-xl text-base sm:text-lg text-slate-300 leading-relaxed">
                From high-precision functional prototypes to custom visual
                models, BroocFab delivers production-grade on-demand FDM and SLA
                fabrication with local engineering expertise.
              </p>
            </div>
            ...
            <div className="pt-6 border-t border-slate-800/80">
              <div className="grid grid-cols-3 gap-6 sm:gap-8">
                <div className="space-y-1">
                  ...
                  <div className="text-[10px] sm:text-xs text-slate-400 uppercase tracking-widest font-bold font-mono">
                    Completed Prints
                  </div>
                </div>
                <div className="space-y-1">
