  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-white/90 max-w-[600px] drop-shadow-md">
                  Structure Lab by BroocFab — Bringing your house plan to life, islandwide & free delivery guaranteed.
                </p>
              </div>

              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" asChild className="text-lg px-8 py-6 bg-green-600 hover:bg-green-700 shadow-lg">
                  <Link href={whatsappLink} target="_blank">
      ...
      <section className="py-20 md:py-32">
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl text-slate-900">How It Works</h2>
            <p className="text-xl text-slate-600 max-w-[800px] mx-auto">
              Three simple steps to get your physical 3D house model delivered to your doorstep.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="border-2 border-slate-100 hover:border-slate-200 transition-colors">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-xl">Upload Your Floor Plan</CardTitle>
                <CardDescription className="text-base">
                  Send us your floor plan in PDF, DWG, PNG, or JPG format. We accept all standard architectural
                  drawings.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 border-slate-100 hover:border-slate-200 transition-colors">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-xl">Choose Your Model Type</CardTitle>
                <CardDescription className="text-base">
            ...
            <Card className="border-2 border-slate-100 hover:border-slate-200 transition-colors">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-base">
                  Physical 3D model shipped safely to your doorstep — anywhere in Sri Lanka, delivery FREE of charge.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="border-2 border-slate-200">
              <CardHeader>
                <CardTitle className="text-center text-2xl">Pricing Structure</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="border-b-2 border-slate-200">
                        <th className="text-left py-4 px-4 font-semibold text-slate-900">Package</th>
                        <th className="text-left py-4 px-4 font-semibold text-slate-900">Color</th>
                        <th className="text-left py-4 px-4 font-semibold text-slate-900">Pricing Basis</th>
                        <th className="text-left py-4 px-4 font-semibold text-slate-900">Example</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-slate-100">
                        ...
                        <td className="py-4 px-4 text-slate-600">2-storey, 1500 sqft</td>
                      </tr>
                      <tr className="border-b border-slate-100">
                        <td className="py-4 px-4 font-medium">Colorful</td>
                        <td className="py-4 px-4">Multi Color</td>
                        <td className="py-4 px-4">Square feet + Floors + Colors</td>
                        <td className="py-4 px-4 text-slate-600">2-storey, 1500 sqft, 5 colors</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <Card className="border-2 border-slate-100">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">Floor plan in PDF, DWG, PNG, or JPG</p>
                    <p className="text-sm text-slate-600">High-resolution files preferred</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <ImageIcon className="h-5 w-5 text-slate-600 mt-1" />
                  <div>
                    <p className="font-medium">Any elevation drawings (optional)</p>
                    <p className="text-sm text-slate-600">Helps us create more accurate models</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Paintbrush className="h-5 w-5 text-slate-600 mt-1" />
                  <div>
                    <p className="font-medium">Color scheme or reference photos</p>
                    <p className="text-sm text-slate-600">For multi-color models only</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-slate-100">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <FileText className="h-5 w-5 text-slate-600 mt-1" />
                  <div>
                    <p className="font-medium">STL file of the final model (optional)</p>
                    <p className="text-sm text-slate-600">Digital file for future reference</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <ImageIcon className="h-5 w-5 text-slate-600 mt-1" />
                  <div>
                    ...
                    <p className="text-sm text-slate-600">For digital use and presentations</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900">Highly Accurate Scaling</h3>
              <p className="text-slate-600">Precise measurements and proportions in every model</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900">Basic or Full-Color Option</h3>
              <p className="text-slate-600">Choose the perfect finish for your needs and budget</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900">Islandwide Delivery</h3>
              <p className="text-slate-600">Always FREE delivery anywhere in Sri Lanka</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-slate-900">Hand-Finished Details</h3>
              <p className="text-slate-600">Professional finishing by BroocFab experts</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6 text-center">
          <div className="space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-slate-300">
              Get your custom quote today and see your house design transformed into a stunning physical 3D model.
            </p>
            ...
            <p className="text-sm text-slate-400">Free delivery islandwide • Professional quality guaranteed</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-white border-t py-16">
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="space-y-4">
              ...
              <p className="text-slate-600 max-w-xs">
                Professional 3D modeling services bringing your architectural plans to life.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Link href="#" className="block text-slate-600 hover:text-slate-900 transition-colors">
                  Terms of Service
                </Link>
                <Link href="#" className="block text-slate-600 hover:text-slate-900 transition-colors">
                  Privacy Policy
          ...
          <div className="border-t border-slate-200 mt-12 pt-8 text-center">
            <p className="text-slate-600 text-sm">© {new Date().getFullYear()} BroocFab. All rights reserved.</p>
          </div>
        </div>
      </footer>
      ...
      <div className="fixed bottom-6 right-6 z-50 md:hidden">
        <Button size="lg" asChild className="rounded-full bg-green-600 hover:bg-green-700 shadow-lg">
          <Link href={whatsappLink} target="_blank">
